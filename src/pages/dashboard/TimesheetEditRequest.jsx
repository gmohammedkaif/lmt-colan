  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Timesheet Edit Request</h1>
          <p className="text-sm text-slate-500 mt-1">
            Request permission to edit locked timesheet entries.
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl border shadow-sm overflow-hidden">
        <table className="w-full">
          <thead className="bg-slate-50">
            <tr>
              <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase">Interval</th>
              <th className="px-5 py-4 text-left text-xs font-bold text-slate-500 uppercase">Valid Upto</th>
